...
public class WorkFLowofBroadex {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //LOGIN //
         ...
         actions1.moveToElement(elements).click(elements).sendKeys("27/01/2023 - 28/01/2023").contextClick(elements).build().perform();
         Driver.findElement(By.xpath("(//*[@class='mdi mdi-magnify'])")).click();
         ...
         actions4.moveToElement(element4).click(element4).sendKeys("01/02/2023 - 03/02/2023").contextClick(element4).build().perform();
         //Driver.findElement(By.id("date-range")).sendKeys("27/01/2023 - 02/02/2023");
         Driver.findElement(By.xpath("(//*[@class='mdi mdi-magnify'])")).click();
         Driver.findElement(By.xpath("(//*[@class='mdc-list-item__text'])")).click();
         ...
         WebElement element3 =Driver.findElement(By.xpath("(//*[@class='selectize-input items not-full has-options'])"));
         Actions actions3 = new Actions(Driver);
         actions3.moveToElement(element3).click(element3).sendKeys("Super Administrator").contextClick(element3).build().perform();
         ...
         actions5.moveToElement(element5).click(element5).sendKeys("27/01/2023 - 02/02/2023").contextClick(element5).build().perform();        
         Driver.findElement(By.xpath("(//*[@class='mdi mdi-magnify'])")).click();
         ...
         actions6.moveToElement(element6).click(element6).sendKeys("1.0.2").doubleClick(element6).contextClick(element6).build().perform();
         Driver.findElement(By.xpath("(//*[@class='mdi mdi-magnify'])")).click();
         ...
         Driver.findElement(By.id("code")).sendKeys("565");
